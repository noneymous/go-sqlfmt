...
func (group *Function) writeFunction(buf *bytes.Buffer, token, previousToken, previousParentToken Token, indent, columnCount int, isColumnArea, isNestedFunction bool) {

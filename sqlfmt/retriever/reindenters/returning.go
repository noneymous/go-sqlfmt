...
func (group *Returning) Reindent(buf *bytes.Buffer, parent []lexer.Reindenter, parentIdx int) error {
...
func (group *Returning) IncrementIndentLevel(lev int) {

...
// Limit group reindenter
// Limit such as LIMIT, OFFSET, FETCH FIRST
type Limit struct {
...
func (group *Limit) Reindent(buf *bytes.Buffer, parent []lexer.Reindenter, parentIdx int) error {
...
func (group *Limit) IncrementIndentLevel(lev int) {

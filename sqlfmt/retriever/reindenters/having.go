...
func (group *Having) Reindent(buf *bytes.Buffer, parent []lexer.Reindenter, parentIdx int) error {
...
func (group *Having) IncrementIndentLevel(lev int) {

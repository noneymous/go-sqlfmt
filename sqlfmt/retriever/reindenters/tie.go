...
func (group *TieGroup) Reindent(buf *bytes.Buffer, parent []lexer.Reindenter, parentIdx int) error {
...
func (group *TieGroup) IncrementIndentLevel(lev int) {

...
func (group *Parenthesis) Reindent(buf *bytes.Buffer, parent []lexer.Reindenter, parentIdx int) error {
...
func (group *Parenthesis) writeParenthesis(buf *bytes.Buffer, token, previousParentToken lexer.Token, indent, columnCount int, isColumnArea, isFirstValue, hasIntermediate bool) {
